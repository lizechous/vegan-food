...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(template_name="RegistroUsuario/password_reset_confirm.html"), name='password_reset_confirm'),
    path('reset/done/', PasswordResetCompleteView.as_view(template_name='RegistroUsuario/password_reset_complete.html'), name='password_reset_complete'),      
